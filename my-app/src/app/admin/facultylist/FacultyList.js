...
function FacultyList() {
    ...
    const fetchFaculties = async () => {
        const response = await fetch('http://ec2-54-153-39-198.us-west-1.compute.amazonaws.com:5000/faculty', {
            method: 'POST',
    ...
    const fetchCourses = async (facultyId) => {
        const response = await fetch('http://ec2-54-153-39-198.us-west-1.compute.amazonaws.com:5000/get_courses_by_faculty', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    const fetchStudents = async (courseId) => {
        const response = await fetch('http://ec2-54-153-39-198.us-west-1.compute.amazonaws.com:5000/people_in_course', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
