...
//     try {
//       const response = await fetch('https://ec2-54-67-80-169.us-west-1.compute.amazonaws.com:3000:5000/get_course_content', {
//         method: 'POST',
//         headers: {
...
//     e.preventDefault();
//     try {
//       const response = await fetch('https://ec2-54-67-80-169.us-west-1.compute.amazonaws.com:3000:5000/add_course_content', {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json'
//         },
...
// //     const fetchCourseContent = async () => {
// //         try {
// //             const response = await axios.post('https://ec2-54-67-80-169.us-west-1.compute.amazonaws.com:3000:5000/get_course_content', { course_id: 'YOUR_COURSE_ID_HERE' });
...
// //         try {
// //             const response = await axios.post('https://ec2-54-67-80-169.us-west-1.compute.amazonaws.com:3000:5000/update_course_content', {
