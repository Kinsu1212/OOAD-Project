...
function Assignment() {
  ...
  const [trying, setTrying] = useState(0);
    ...
    const fetchAssignments = async () => {
      try {
        ...
        const response = await fetch('ec2-54-183-22-164.us-west-1.compute.amazonaws.com:5000/get_assignment', {
                                  method: 'POST',
                                  headers: {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('ec2-54-183-22-164.us-west-1.compute.amazonaws.com:5000/create_assignment', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const togglePublish = async (assignmentId, isPublished) => {
    try {
      ...
      const response = await fetch(`ec2-54-183-22-164.us-west-1.compute.amazonaws.com:5000/toggle_publish/${assignmentId}`, {
        method: 'POST',
