...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    const fetchCurrentCourses = async () => {
      try {
        const response = await fetch('https://ec2-54-67-80-169.us-west-1.compute.amazonaws.com:5000/get_current_faculty_courses', {
                                  method: 'POST',
                                  headers: {
    ...
    const fetchUnpublishedCourses = async () => {
      try {
        const response = await fetch('https://ec2-54-67-80-169.us-west-1.compute.amazonaws.com:5000/get_unpublished_faculty_courses', {
                                  method: 'POST',
                                  headers: {
                                    'Content-Type': 'application/json'
                                  },
